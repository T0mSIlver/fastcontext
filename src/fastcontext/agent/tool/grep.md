...
- Output is capped at the first 1000 lines by default; raise or lower this with the head_limit parameter. When truncation occurs, the output ends with a "Results truncated to first N lines" note.
